...
STATIC_URL = 'static/'
STATICFILES_DIRS = [SVELTEKIT_BUILD_DIR]
...
TELEGRAM_BUILDER_BOT_WEBHOOK_SECRET = getenv('TELEGRAM_BUILDER_BOT_WEBHOOK_SECRET', None)
TELEGRAM_BUILDER_BOT_TOKEN = getenv('TELEGRAM_BUILDER_BOT_TOKEN', '')
TELEGRAM_BUILDER_BOT_ADMINS = map(int, getenv('TELEGRAM_BUILDER_BOT_ADMINS', '').split(','))
