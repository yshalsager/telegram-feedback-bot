...
TELEGRAM_WEBHOOK_URL = getenv('TELEGRAM_WEBHOOK_URL', 'https://yourdomain.com')
TELEGRAM_ENCRYPTION_KEY = getenv('TELEGRAM_ENCRYPTION_KEY', '')
TELEGRAM_BOT_TOKEN = getenv('TELEGRAM_BOT_TOKEN', '')
TELEGRAM_BOT_ADMINS = getenv('TELEGRAM_BOT_ADMINS', '').split(',')

if not any(
    (TELEGRAM_WEBHOOK_URL, TELEGRAM_ENCRYPTION_KEY, TELEGRAM_BOT_TOKEN, TELEGRAM_BOT_ADMINS)
):
